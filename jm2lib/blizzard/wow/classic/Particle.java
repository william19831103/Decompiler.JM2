...
public class Particle implements Referencer {
   ...
   public void unmarshal(UnmarshalingStream in) throws IOException, ClassNotFoundException {
      ...
      this.blendingType = in.readChar();
      this.emitterType = in.readChar();
   ...
   public void marshal(MarshalingStream out) throws IOException {
      ...
      out.writeChar(this.blendingType);
      out.writeChar(this.emitterType);
   ...
   public jm2lib.blizzard.wow.lateburningcrusade.Particle upConvert() {
      ...
      output.blendingType = (byte)this.blendingType;
      output.emitterType = (byte)this.emitterType;
